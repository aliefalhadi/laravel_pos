                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            ...
                                            <li  x-data="{ idUser: {{$item->id}} }">  
                                                <button x-on:click="confirm('apakah anda yakin?') ? $wire.call('delete', idUser) :console.log('gagal')" class="btn btn-outline-danger btn-rounded btn-sm"
